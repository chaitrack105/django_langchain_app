...
# 2. Lead Prioritization Assistant
def create_lead_prioritization_assistant():
    assistant = ContextAwareAssistant()
    
    # Load lead scoring models, behavioral data, engagement patterns
    # assistant.load_context_documents(['lead_scoring_model.pdf', 'engagement_patterns.txt', 'conversion_data.csv'])
    
    assistant.create_system_prompt(
        domain_context="lead prioritization and scoring",
...
def generate_response(user_input, recent_messages=None, assistant_type="code", use_context=True):
    ...
    Args:
        ...
        assistant_type (str): Type of assistant ("code", "support", "lead_priority", or "general")
...
if __name__ == "__main__":
    ...
    # Method 2: Using lead prioritization assistant
    lead_response = generate_response(
        "Score this lead: visited pricing page 5 times, downloaded whitepaper, from LinkedIn ads, company size 500+ employees",
        assistant_type="lead_priority"
    )
    print("Lead scoring response:", lead_response)
